globals [
  ...
  strategy-numbers          ;; <= new global variable
  strategy-frequencies      ;; <= new global variable
  strategy-expected-payoffs ;; <= new global variable
]
...
to setup
  ...
  setup-graph
  reset-ticks
  update-strategy-expected-payoffs ;; <= new line
  update-graph
end
...
to setup-payoffs
  ...
  set strategy-numbers range n-of-strategies  ;; <= new line
end
